...
class BattleCombined: JsonBean {

    var api_result: Int = 0
    var api_result_msg: String = ""
    var api_data: BattleCombinedData? = BattleCombinedData()
    ...
    override func process() {
        ...
        Battle.instance.phaseShift(value: Phase.BattleCombined)
    }
}

class BattleCombinedData: HandyJSON {
...
class ApiCombinedKouku: HandyJSON {

    var api_plane_from = Array<Array<Int>>()
...
class ApiStage3Combined: HandyJSON {
