...
class BattleNight: JsonBean {

    var api_result: Int = 0
    var api_result_msg: String = ""
    var api_data: BattleNightApiData? = BattleNightApiData()
    ...
    override func process() {
        ...
        Battle.instance.phaseShift(value: Phase.BattleNight)
    }

}

class BattleNightApiData: HandyJSON {
